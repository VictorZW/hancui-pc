          ...
          <div class="cover-model">
            ...
            >
              <div class="pro-msg">
                ...
                <div class="detail text-align-justify">{{ item.instruction }}</div>
                <div class="read-more">
                  <span>查看更多</span>
                </div>
              </div>
      ...
      <div class="page page5">
        <div class="left">
          <div class="text-content">
            ...
            <div class="desc text-align-justify">
        ...
        <div class="po-text-area">
          <div class="content">
            <div class="content-1">
              ...
              <div class="desc text-align-justify">2018年汉萃与芳香芳疗产业协会合作成立检测研发中心，为芳香行业企业提供技术支持与服务；并与美国著名生物研究机构紧密合作，主营业务是天然植物健康产品、芳香疗法和护肤肽类终端产品的技术研发与销售、健康咨询服务。关联公司山东汉肽生物医药有限公司，目前拥有3000平方米的研发基地和10000余平方米的生产基地，并与山东大学合作，成立“山东大学汉肽生物技术研究院”，致力于研发针对糖尿病、肿瘤、心血管疾病、耐药菌感染等重大疾病的药物，并研发了30种美容肽原料、发酵生产胶原蛋白等工艺，推出了多款活性肽产品。</div>
            </div>
            <div class="content-1">
              <div class="icon-area">
...
<script>
  ...
  export default {
    ...
    metaInfo () {
      return {
        meta: [
          { vmid: 'keywords', name: 'keywords', content: '活性肽品牌,冻干粉什么牌子好,芊栢荟精油,国际芳疗师培训,精油哪个品牌好,芊栢荟活性肽,汉萃芳疗荟,活性肽护肤品,汉萃芳疗精油,汉萃生物,汉萃（天津）生物科技股份有限公司,汉萃（上海）生物科股份有限公司,芳香疗法精油' }
        ]
      }
    },
    mounted() {
