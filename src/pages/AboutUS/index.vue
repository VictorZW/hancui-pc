...
<script>
  ...
  export default {
    ...
    metaInfo () {
      return {
        meta: [
          { vmid: 'keywords', name: 'keywords', content: '芳疗品牌有哪些,中国芳疗品牌,芳疗品牌中国总代理,活性肽实验室,精油实验室,天津上市公司名单2020,汉萃（天津）生物技术股份有限公司,汉萃天津,汉萃公众号,芊栢荟公众号,汉萃是什么公司,汉萃公司介绍,活性肽公司有哪些,精油原料' }
        ]
      }
    },
    mounted() {
