...
<script>
  export default {
    ...
    metaInfo () {
      return {
        meta: [
          { vmid: 'keywords', name: 'keywords', content: 'ifa,ifa芳疗师资格证,ifa国际芳疗师培训,CRA芳疗师,cra芳疗培训课程,芳疗师资格证怎么考,芳疗师月收入大概多少,国际芳疗师资格证怎么考,国际芳疗师认证培训,国际芳疗师认证书都有哪些,中华注册芳疗师协会证书,如何使用精油,芳疗师如何赚钱' }
        ]
      }
    },
    methods: {
